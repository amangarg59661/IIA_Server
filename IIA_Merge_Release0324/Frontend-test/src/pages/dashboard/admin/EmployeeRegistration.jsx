            ...
            <Row gutter={16}>
              <Col xs={24} sm={12} lg={8}>
                <Form.Item
                  ...
                  rules={[{ required: true, message: 'Please enter Employee ID' },
                   { pattern: /^\S+$/, message: 'Employee ID must not contain spaces' }]}
                    tooltip="Enter a unique Employee ID (e.g. E1001, EMP001)"
                >
                  <Input
              ...
              <Col xs={24} sm={12} lg={8}>
                ...
                >
                  ...
                  <Input placeholder="Enter phone or landline number" maxLength={15} />
                </Form.Item>
              </Col>
              <Col xs={24} sm={12} lg={8}>
                <Form.Item
            ...
            <Row gutter={16}>
              ...
              <Col xs={24} sm={12} lg={8}>
                <Form.Item
                  ...
                  rules={[
                    { required: true, message: 'Please enter phone number' },
                     { pattern: /^\d{7,15}$/, message: 'Please enter 7-15 digit phone/landline number' }
                    // { pattern: /^\d{10}$/, message: 'Please enter 10-digit phone number' }
                  ]}
                >
                  {/* <Input placeholder="Enter phone number" maxLength={10} /> */}
