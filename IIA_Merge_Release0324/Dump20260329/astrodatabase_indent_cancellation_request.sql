...
--
-- Dumping data for table `indent_cancellation_request`
--

LOCK TABLES `indent_cancellation_request` WRITE;
/*!40000 ALTER TABLE `indent_cancellation_request` DISABLE KEYS */;
/*!40000 ALTER TABLE `indent_cancellation_request` ENABLE KEYS */;
UNLOCK TABLES;
