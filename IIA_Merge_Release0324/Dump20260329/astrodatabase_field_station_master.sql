...
--
-- Dumping data for table `field_station_master`
--

LOCK TABLES `field_station_master` WRITE;
/*!40000 ALTER TABLE `field_station_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `field_station_master` ENABLE KEYS */;
UNLOCK TABLES;
