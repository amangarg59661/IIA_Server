...
--
-- Dumping data for table `material_disposal`
--

LOCK TABLES `material_disposal` WRITE;
/*!40000 ALTER TABLE `material_disposal` DISABLE KEYS */;
/*!40000 ALTER TABLE `material_disposal` ENABLE KEYS */;
UNLOCK TABLES;
