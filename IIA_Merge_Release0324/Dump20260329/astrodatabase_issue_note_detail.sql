...
--
-- Dumping data for table `issue_note_detail`
--

LOCK TABLES `issue_note_detail` WRITE;
/*!40000 ALTER TABLE `issue_note_detail` DISABLE KEYS */;
INSERT INTO `issue_note_detail` VALUES (1,1,1,1,1.00),(2,2,1,1,1.00),(3,3,1,1,1.00),(4,4,6,1,1.00),(5,5,1,1,1.00);
/*!40000 ALTER TABLE `issue_note_detail` ENABLE KEYS */;
UNLOCK TABLES;
