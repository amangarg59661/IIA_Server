...
--
-- Dumping data for table `gatepass_out_in`
--

LOCK TABLES `gatepass_out_in` WRITE;
/*!40000 ALTER TABLE `gatepass_out_in` DISABLE KEYS */;
/*!40000 ALTER TABLE `gatepass_out_in` ENABLE KEYS */;
UNLOCK TABLES;
