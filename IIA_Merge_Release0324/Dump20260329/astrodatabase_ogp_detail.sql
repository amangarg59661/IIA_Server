...
--
-- Dumping data for table `ogp_detail`
--

LOCK TABLES `ogp_detail` WRITE;
/*!40000 ALTER TABLE `ogp_detail` DISABLE KEYS */;
INSERT INTO `ogp_detail` VALUES (1,'INV1',1,1,1,1,1.00),(2,'INV2',2,2,1,1,1.00),(3,'INV3',3,3,1,1,1.00),(4,'INV4',4,4,6,1,1.00),(5,'INV5',5,5,1,1,1.00);
/*!40000 ALTER TABLE `ogp_detail` ENABLE KEYS */;
UNLOCK TABLES;
