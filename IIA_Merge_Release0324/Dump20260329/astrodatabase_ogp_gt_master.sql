...
--
-- Dumping data for table `ogp_gt_master`
--

LOCK TABLES `ogp_gt_master` WRITE;
/*!40000 ALTER TABLE `ogp_gt_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `ogp_gt_master` ENABLE KEYS */;
UNLOCK TABLES;
