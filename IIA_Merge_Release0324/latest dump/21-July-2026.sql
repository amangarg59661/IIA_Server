...
) ENGINE=InnoDB AUTO_INCREMENT=5360 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `gem_tender_evaluation`
--

DROP TABLE IF EXISTS `gem_tender_evaluation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gem_tender_evaluation` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `payment_voucher` (
  ...
  `cp_details` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `purchase_order` (
  ...
  `vendor_swift_code` varchar(255) DEFAULT NULL,
...
CREATE TABLE `service_order` (
  ...
  `vendor_swift_code` varchar(255) DEFAULT NULL,
  `vendor_type` varchar(255) DEFAULT NULL,
  `additional_terms_and_conditions` varchar(255) DEFAULT NULL,
  `buy_back_amount` decimal(19,2) DEFAULT NULL,
  `comparative_statement_file_name` varchar(255) DEFAULT NULL,
  `delivery_date` date DEFAULT NULL,
  `delivery_period` varchar(255) DEFAULT NULL,
  `expiry_date` date DEFAULT NULL,
  `gem_contract_file_name` varchar(255) DEFAULT NULL,
  `indent_id` varchar(255) DEFAULT NULL,
  `is_cancelled` bit(1) DEFAULT NULL,
  `is_locked` bit(1) DEFAULT NULL,
  `quotation_date` date DEFAULT NULL,
...
CREATE TABLE `service_order_material` (
  ...
  `updated_by` varchar(50) DEFAULT NULL,
  `received_quantity` decimal(19,2) DEFAULT NULL,
  `total_so_material_price_in_inr` decimal(19,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `so_id` (`so_id`),
...
--
-- Table structure for table `tender_clarification_history`
--

DROP TABLE IF EXISTS `tender_clarification_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tender_clarification_history` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tender_id` varchar(255) NOT NULL,
...
--
-- Table structure for table `tender_committee_vendor_decision`
--

DROP TABLE IF EXISTS `tender_committee_vendor_decision`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tender_committee_vendor_decision` (
  ...
  `voter_role` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tender_vendor_member_phase_role` (`tender_id`,`vendor_id`,`committee_user_id`,`phase`,`voter_role`)
...
CREATE TABLE `tender_evaluation` (
  ...
  `ad_hoc_chairman_name` varchar(200) DEFAULT NULL,
  `ad_hoc_chairman_user_id` int DEFAULT NULL,
  `ad_hoc_co_chairman_name` varchar(200) DEFAULT NULL,
  `ad_hoc_co_chairman_user_id` int DEFAULT NULL,
  `amount_category` varchar(30) DEFAULT NULL,
  `approval_remarks` longtext,
  `approved_vendor_id` varchar(100) DEFAULT NULL,
  `approved_vendor_name` longtext,
  `bid_type` varchar(20) DEFAULT NULL,
  `clarification_pending_from` varchar(50) DEFAULT NULL,
  `clarification_pending_from_id` int DEFAULT NULL,
  `clarification_pending_from_name` varchar(200) DEFAULT NULL,
  `clarification_remarks` text,
  `clarification_requested_by_role` varchar(50) DEFAULT NULL,
  `evaluation_status` varchar(100) DEFAULT NULL,
  `financial_bid_phase` bit(1) DEFAULT NULL,
  `indent_category` varchar(20) DEFAULT NULL,
  `previous_evaluation_status` varchar(100) DEFAULT NULL,
  `total_tender_value` decimal(18,2) DEFAULT NULL,
  `vendor_portal_registered` bit(1) DEFAULT NULL,
  `initiated` int NOT NULL,
  `rejected_by_role` varchar(50) DEFAULT NULL,
  `rejected_by_user_id` int DEFAULT NULL,
  `clarification_target_vendor_id` varchar(100) DEFAULT NULL,
  `expert_name` varchar(200) DEFAULT NULL,
  `expert_user_id` int DEFAULT NULL,
...
CREATE TABLE `vendor_master` (
  ...
  `vendor_mastercol` varchar(45) DEFAULT 'Active',
...
CREATE TABLE `vendor_quotation_against_tender` (
  ...
  `financial_bid_visible` bit(1) DEFAULT NULL,
  `rank` int DEFAULT NULL,
  `technical_evaluated_by` int DEFAULT NULL,
  `technical_evaluated_date` datetime DEFAULT NULL,
  `technical_remarks` longtext,
  `technical_status` varchar(20) DEFAULT NULL,
  `financial_indentor_remarks` longtext,
  `financial_indentor_status` varchar(30) DEFAULT NULL,
  `financial_spo_remarks` longtext,
  `financial_spo_status` varchar(30) DEFAULT NULL,
  `registered_vendor_id` varchar(100) DEFAULT NULL,
  `registered_vendor_name` longtext,
  `pp_doc_upload_remarks` text,
  PRIMARY KEY (`id`)
...
CREATE TABLE `workflow_master` (
  ...
  `createdDate` datetime DEFAULT NULL,
  `createdBy` varchar(45) DEFAULT NULL,
  `Workflow_Limit` int DEFAULT NULL,
...
-- Dump completed on 2026-07-21 13:55:57
